...
import {
  ...
  HoverCardContent,
  HoverCardTrigger,
} from "@freenary/ui/components/hover-card";
import {
  InputGroup,
  InputGroupAddon,
  InputGroupButton,
...
// Base UI puts the open/close delay on the trigger, not the root, and defaults
// to 600ms/300ms; an attachment preview has to appear as the pointer lands.
