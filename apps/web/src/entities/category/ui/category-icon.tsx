...
const FILL_ICON_BY_NAME = {
  ...
  BankIcon: RiBankFill,
  BitcoinIcon: RiBitCoinFill,
  BriefcaseIcon: RiBriefcaseFill,
  CarIcon: RiCarFill,
  CashIcon: RiCashFill,
  ChartPieIcon: RiPieChartFill,
