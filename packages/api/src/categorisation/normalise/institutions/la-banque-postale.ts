...
const NAME_PATTERNS = {
  "banque postale": true,
  "la banque postale": true,
} as const satisfies Record<string, true>;

// ── Regex patterns ───────────────────────────────────────────────────────

/** ACHAT CB payee DD.MM.YY — DOT dates, date as suffix. */
const ACHAT_CB_RE =
...
const PATTERNS: readonly PatternRule[] = [
  { channel: "card", dateParser: parseLbpDate, re: ACHAT_CB_RE },
...
export const laBanquePostale: InstitutionParser = {
