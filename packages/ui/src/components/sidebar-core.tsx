...
import { Button, type ButtonProps } from "@freenary/ui/components/button";
  ...
  ({ className, render, asChild, children, ...props }, ref) => {
        ...
        "button",
        {
          ...
          style:
            group.actionsCount > 0
              ...
              : undefined,
          className: cn(
            "text-muted-foreground/70 flex h-8 w-full shrink-0 cursor-pointer items-center gap-2 px-2 text-left outline-none select-none",
    ...
    return slotElement(
      ...
      "div",
      {
        ...
        "data-sidebar": "group-label",
        className: cn(
          "text-muted-foreground/70 flex h-8 shrink-0 items-center gap-2 px-2 outline-none",
          sizeVariant === "compact" ? "text-[11px]" : "text-[12px]",
          className
        ),
        ...props,
