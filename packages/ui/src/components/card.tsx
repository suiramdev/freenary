      ...
      <CardGroupContext.Provider value={contextValue}>
        <div
          ...
          className={cn(
            ...
            outlined &&
              !separated &&
              `border-border/60 overflow-hidden border ${shape.container}`,
...
const Card = forwardRef<HTMLDivElement, CardProps>(
  (
    ...
    const tileShape = group
      ? separated && outlined
        ? cn(shape.container, "border-border/60 overflow-hidden border")
        : ""
        ...
        <div
          ...
          className={cn(
            ...
            !group &&
              clickable &&
              !disabled &&
              "hover:bg-hover transition-colors duration-80",
        ...
        >
          ...
          {selected && (
            <span
              aria-hidden
              className={cn(
                "bg-active pointer-events-none absolute inset-0 -z-10",
                shape.container
              )}
            />
          )}
          ...
          {dismissible && (
            <button
              ...
              className={cn(
                ...
                // radius either way.
                hasImage
                  ? "bg-card/70 hover:bg-card backdrop-blur-sm"
                  : "hover:bg-hover",
                ...
                dismissOnHover &&
                  "pointer-events-none opacity-0 transition-opacity duration-80 group-focus-within/card:pointer-events-auto group-focus-within/card:opacity-100 group-hover/card:pointer-events-auto group-hover/card:opacity-100 focus-visible:pointer-events-auto focus-visible:opacity-100",
                shape.button
              )}
            >
  ...
  ({ className, children, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <span
          className={cn(
            "text-foreground col-start-1 row-start-1 min-w-0 overflow-hidden text-ellipsis transition-[font-variation-settings] duration-80",
            trim
          )}
          style={{
  ...
  if (Icon) {
    ...
    return (
      <span
        data-slot="card-media"
        className={cn(
          "bg-hover inline-flex size-8 shrink-0 items-center justify-center",
          shape.bg,
          wrap
        )}
      >
