...
- **No app imports allowed.** This package depends on React, Base UI, `motion`, `lucide-react`, `pdfjs-dist` and Tailwind — never on `@freenary/api`, `@freenary/db`, or any app workspace.
